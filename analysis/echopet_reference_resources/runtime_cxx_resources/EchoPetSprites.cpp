...
const uint8_t kMameSweepBitmap[] PROGMEM = {
    0x01, 0x00,  // .......#........
    0x02, 0x00,  // ......#.........
    0x04, 0x00,  // .....#..........
    0x08, 0x00,  // ....#...........
...
const BitmapAsset kBitmapAssets[] = {
    ...
    {16, 8, 2, kMameSweepBitmap},         {8, 8, 1, kMameSkullBitmap},
...
const FramePart kFrameToiletSweep0Parts[] PROGMEM = {
    {0, 0, B_MAME_BODY, 0},      {6, 12, B_EYE_SAD, 0},
    {19, 12, B_EYE_SAD, kPartFlipX}, {8, 19, B_MOUTH_SAD, 0},
    {8, 27, B_FOOT, 0},          {20, 27, B_FOOT, kPartFlipX},
    {2, 23, B_MESS, 0},          {13, 22, B_SWEEP, 0},
};

const FramePart kFrameToiletSweep1Parts[] PROGMEM = {
    {0, -1, B_MAME_BODY, 0},     {7, 12, B_EYE_BLINK, 0},
    {18, 12, B_EYE_BLINK, 0},    {8, 18, B_MOUTH_SMILE, 0},
    {7, 27, B_FOOT, 0},          {21, 27, B_FOOT, kPartFlipX},
    {22, 23, B_MESS, 0},         {1, 22, B_SWEEP, kPartFlipX},
};
...
const ComposedFrame kFrameToiletSweep0Composed = {
    32, 32, kFrameToiletSweep0Parts,
    sizeof(kFrameToiletSweep0Parts) / sizeof(kFrameToiletSweep0Parts[0])};
const ComposedFrame kFrameToiletSweep1Composed = {
    32, 32, kFrameToiletSweep1Parts,
    sizeof(kFrameToiletSweep1Parts) / sizeof(kFrameToiletSweep1Parts[0])};
...
const ComposedFrame* connectFrame(SpriteFrame frame) {
  switch (frame) {
    ...
    case SpriteFrame::kToiletSweep0:
      return &kFrameToiletSweep0Composed;
    case SpriteFrame::kToiletSweep1:
      return &kFrameToiletSweep1Composed;
...
void drawBitmapAsset(Adafruit_SSD1681& display, const BitmapAsset& bitmap,
...
void drawComposedFrame(Adafruit_SSD1681& display, const ComposedFrame& frame,
...
SpriteFrame selectSpriteFrame(const Snapshot& pet, uint8_t phase) {
  ...
  switch (pet.notice) {
    ...
    case Notice::kClean:
      switch (phase & 0x03) {
        case 1:
          return SpriteFrame::kToiletSweep0;
        case 2:
          return SpriteFrame::kToiletSweep1;
        case 3:
